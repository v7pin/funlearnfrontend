    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-cyan-300 via-cyan-100 to-cyan-50">
      <div className="bg-white rounded-lg shadow-xl p-8 w-full max-w-md mt-16 mb-8">
        ...
        <div className="text-center">
          <h1 className="text-2xl font-bold text-purple-800 my-4 mb-2 uppercase">FunLearn Registration Form</h1>
          <p className="text-rose-600 uppercase mt-4 mb-8 font-semibold">Kshitiksha Foundation 📚</p>
          <p className="text-gray-600 mt-2 mb-4 font-normal text-sm">"The journey of a thousand miles begins with one step. Embrace the adventure of learning with us at FUNLEARN by Kshitiksha Foundation."</p>
        </div>
        <form onSubmit={handleSubmit} className="space-y-6">
          <InputField icon={<FaUser />} name="name" label="Name" placeholder="Enter your name" value={formData.name} onChange={handleChange} error={formErrors.name} />
          ...
          {formErrors.interests && <p className="text-red-600">{formErrors.interests}</p>}
...
function InputField({ icon, name, label, placeholder, value, onChange, error }) {
  return (
    <div>
